...
body.addEventListener("scroll", yValue);
...
function popUp(e) {
  ...
  if (this.parentElement.querySelector(".category").value != "combo") {
    ...
    copy.querySelector(".cursor").classList.add("inUse");
    //append
    document.querySelector("main").appendChild(copy);
    //cursor
    let cursor = document.querySelector(".bg-modal .inUse");
    ...
    //cursor
    let cursor = document.querySelector(".bg-modal .cursor.inUse");
    document
